...
<html >
    ...
    <table width='800'>
        ...
        <b>HST/GST Number:</b>{{$invoice_data['user_info']->user_tax_number}}<br />
        <b>HST/GST Rate:</b> {{$invoice_data['user_info']->user_tax*100}}%<br />
        <b>Other Tax Number:</b> {{$invoice_data['user_info']->user_tax_other_number}}<br />
        <b>Other Tax Rate:</b> {{$invoice_data['user_info']->user_tax_other*100}}%</td>

        <td valign='top'>
            <b>Invoice Number:</b> {{$invoice_data['invoice_info']['invoice_number']}}<br />
            <b>Invoice Date:</b> {{$invoice_data['invoice_info']['invoice_date']}}<br />
            <b>Invoice Period:</b> {{$invoice_data['invoice_info']['invoice_period']}}<br /><br />
            {!!$invoice_data['user_info']->bill_address!!}
        </td>
        </tr>
        </table>
        <br />
